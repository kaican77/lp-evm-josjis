...
type Verdict = { llm?: { action: string; score: number; summary?: string }; gmgn?: { smartWallets?: number; kolWallets?: number; holders?: number; rugRatio?: number; top10Rate?: number; sellTax?: number } };
type AutoLpResult = { opened: boolean; result?: any; symbol: string; sizeEth: string };
import type { SpikeHit } from "../types.js";
type NewTokenAlert = any;
type OutOfRangeAlert = any;
type ScreenResult = any;
type AutoCloseInfo = any;
type RebalanceInfo = any;
type CompoundInfo = any;
